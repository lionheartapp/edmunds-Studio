    ...
    <div className="relative min-h-screen py-10 px-4 md:px-8">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-12 gap-3 auto-rows-auto">
          ...
          {/* ── No Edmunds Ads — Edmunds Ad Products Showcase ── */}
          {!edmundsAdsLoading && (!edmundsAds || !edmundsAds.models || edmundsAds.models.length === 0) && (
            <div className="col-span-12 animate-[fade-in-up_0.5s_ease-out_both]">
              {/* Section header — Edmunds branded */}
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-eds-50/15 border border-eds-50/25 flex items-center justify-center flex-shrink-0">
                    <svg width="16" height="11" viewBox="0 0 260 175" fill="none" className="text-eds-60">
                      <path fillRule="evenodd" clipRule="evenodd" d="M252.241 43.348C255.974 43.247 259.154 46.136 259.254 49.861H259.264L259.455 57.12C259.556 60.855 256.668 64.036 252.945 64.137L237.37 65.939C237.423 66.053 237.476 66.179 237.525 66.294L237.571 66.402C241.747 71.788 249.605 86.718 249.605 107.88C249.605 117.153 247.885 128.718 246.5 138.031C245.845 142.438 245.264 146.34 244.977 149.257V162.788C244.977 169.533 239.513 175 232.772 175H216.21C209.469 175 204.005 169.533 204.005 162.788V152.731C186.648 151.14 158.345 150.596 129.9 150.546C101.455 150.596 73.152 151.14 55.795 152.731V162.788C55.795 169.533 50.332 175 43.59 175H27.029C20.287 175 14.824 169.533 14.824 162.788V149.257C14.536 146.34 13.956 142.438 13.3 138.031C11.915 128.718 10.195 117.153 10.195 107.88C10.195 98.346 11.151 90.906 12.862 85.057C13.797 79.429 16.977 72.402 22.219 66.402L22.541 65.647L22.35 65.969L6.513 64.137C2.79 64.026 -0.098 60.845 0.003 57.12L0.184 49.861C0.294 46.136 3.474 43.247 7.197 43.348L22.098 43.76C25.459 43.851 28.135 46.438 28.558 49.67C28.679 50.546 28.89 51.412 29.131 52.267L31.013 48.553C37.09 37.307 45.391 23.797 53.732 15.29C53.732 15.29 61.057 6.299 75.748 3.329L75.828 3.309C88.627 0.581 109.465 -0.124 129.89 0.017C150.315 -0.124 171.153 0.571 183.932 3.299L183.95 3.305C183.971 3.313 183.988 3.319 184.012 3.319C198.702 6.289 206.027 15.28 206.027 15.28C214.369 23.787 222.67 37.307 228.747 48.542L230.427 51.855C230.618 51.14 230.779 50.405 230.88 49.67C231.313 46.438 233.989 43.851 237.34 43.76L252.241 43.348ZM34.585 107.236C35.329 114.726 41.387 120.787 48.873 121.532C58.985 122.538 67.427 114.102 66.42 103.974C65.676 96.484 59.619 90.423 52.133 89.678C42.021 88.671 33.579 97.108 34.585 107.236ZM193.309 107.236C194.054 114.726 200.111 120.787 207.597 121.532C217.709 122.538 226.151 114.102 225.145 103.974C224.4 96.484 218.343 90.423 210.857 89.678C200.745 88.671 192.303 97.108 193.309 107.236ZM62.547 51.975V39.19C62.547 34.861 66.873 31.357 72.226 31.357H95.71C101.063 31.357 105.39 34.861 105.39 39.19V51.965C105.39 52.72 105.249 53.455 104.997 54.15H108.016C111.678 54.14 115.381 54.14 119.124 54.15H140.686C144.429 54.14 148.132 54.14 151.794 54.15H156.604C160.742 54.209 165.145 54.302 167.636 54.355L168.889 54.382C186.628 54.835 203.109 56.053 217.588 59.123C213.946 49.801 206.269 34.851 197.153 25.428C195.543 23.847 189.264 18.229 179.867 16.578C175.289 15.873 158.888 13.427 133.391 13.427H126.409C100.912 13.427 84.511 15.873 79.933 16.578C70.526 18.229 64.257 23.847 62.647 25.428C53.531 34.851 45.854 49.801 42.212 59.123C49.024 57.684 56.288 56.657 63.905 55.922C63.06 54.764 62.547 53.425 62.547 51.975ZM129.729 134.388C132.476 134.297 135.243 133.995 138.02 133.472C157.962 129.716 173.427 115.662 180.259 97.631C170.61 108.625 151.352 114.323 129.729 114.565C108.106 114.313 88.858 108.625 79.199 97.631C86.031 115.662 101.496 129.716 121.438 133.472C124.215 133.985 126.982 134.287 129.729 134.388ZM164.201 28.236H187.675L187.685 28.246C193.038 28.246 197.365 31.749 197.365 36.078V48.854C197.365 49.679 197.164 50.505 196.952 51.119C192.012 45.139 182.101 41.434 175.943 41.434C167.502 41.434 159.875 45.34 154.934 51.32C154.522 50.495 154.522 49.669 154.522 48.844V36.068C154.522 31.739 158.848 28.236 164.201 28.236Z" fill="currentColor" />
                    </svg>
                  </div>
                  <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Edmunds Advertising</span>
                </div>
                <span className="text-[10px] text-emerald-400/80 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-full font-semibold uppercase tracking-wider">
                  {brandDna.name} not yet on Edmunds
                </span>
              </div>

              {/* Bento grid — Edmunds ad products */}
              <div className="grid grid-cols-12 gap-3">

                {/* ── Headline stat banner ── */}
                <div className="col-span-12 relative rounded-xl overflow-hidden border border-eds-50/15 p-5" style={{ background: "linear-gradient(135deg, rgba(32,112,232,0.08) 0%, rgba(32,112,232,0.02) 100%)" }}>
                  <div className="flex items-center justify-between gap-6 flex-wrap">
                    <div>
                      <p className="text-sm text-zinc-400 mb-1">Edmunds reaches</p>
                      <p className="text-2xl font-bold text-white">20M+ in-market shoppers <span className="text-eds-60">every month</span></p>
                    </div>
                    <div className="flex gap-6">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-eds-60">84%</p>
                        <p className="text-[11px] text-zinc-500">visit a dealer within 30 days</p>
                      </div>
                      <div className="text-center">
                        <p className="text-2xl font-bold text-eds-60">$0.12</p>
                        <p className="text-[11px] text-zinc-500">avg cost per engaged shopper</p>
                      </div>
                      <div className="text-center">
                        <p className="text-2xl font-bold text-eds-60">3.2x</p>
                        <p className="text-[11px] text-zinc-500">purchase intent vs. social</p>
                      </div>
                    </div>
                  </div>
                </div>

                {/* ── Display Banner — wide format ── */}
                <div className="col-span-12 md:col-span-7 group relative rounded-xl overflow-hidden border border-white/[0.06] hover:border-eds-50/25 transition-colors cursor-pointer" style={{ background: "rgba(24, 24, 27, 0.9)" }}>
                  <div className="p-5">
                    <div className="flex items-start justify-between gap-4 mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-eds-50/10 border border-eds-50/20 flex items-center justify-center flex-shrink-0">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-eds-60">
                            <rect x="2" y="3" width="20" height="14" rx="2" />
                            <path d="M8 21h8" /><path d="M12 17v4" />
                          </svg>
                        </div>
                        <div>
                          <p className="text-sm font-semibold text-zinc-200">Display Banner</p>
                          <p className="text-[11px] text-zinc-500">High-visibility placements across vehicle pages</p>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold text-eds-60 bg-eds-50/10 border border-eds-50/20 px-2 py-0.5 rounded-full whitespace-nowrap">TOP PERFORMER</span>
                    </div>
                    {/* Banner mockup */}
                    <div className="relative rounded-lg overflow-hidden border border-white/[0.06] h-20" style={{ background: "linear-gradient(90deg, rgba(32,112,232,0.12), rgba(78,145,245,0.06), rgba(32,112,232,0.12))" }}>
                      <div className="absolute inset-0 flex items-center justify-between px-5">
                        <div>
                          <p className="text-xs font-semibold text-zinc-300">Shop {brandDna.name} Deals Near You</p>
                          <p className="text-[10px] text-zinc-500 mt-0.5">edmunds.com/{brandDna.name.toLowerCase().replace(/\s+/g, "-")}</p>
                        </div>
                        <div className="px-3 py-1.5 rounded bg-eds-50/90 text-[11px] font-semibold text-white">
                          View Inventory
                        </div>
                      </div>
                      {/* Scan line effect */}
                      <div className="absolute inset-y-0 left-0 w-px bg-eds-50/20" />
                      <div className="absolute inset-y-0 right-0 w-px bg-eds-50/20" />
                    </div>
                  </div>
                </div>

                {/* ── Spotlight — premium square ── */}
                <div className="col-span-12 md:col-span-5 group relative rounded-xl overflow-hidden border border-white/[0.06] hover:border-eds-50/25 transition-colors cursor-pointer" style={{ background: "rgba(24, 24, 27, 0.9)" }}>
                  <div className="p-5 h-full flex flex-col">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-zinc-200">Spotlight</p>
                        <p className="text-[11px] text-zinc-500">Premium branded takeover</p>
                      </div>
                    </div>
                    {/* Spotlight mockup — editorial card */}
                    <div className="flex-1 relative rounded-lg overflow-hidden border border-white/[0.06] min-h-[80px]" style={{ background: "linear-gradient(135deg, rgba(245,158,11,0.06), rgba(32,112,232,0.04))" }}>
                      <div className="absolute inset-0 p-4 flex flex-col justify-between">
                        <span className="text-[10px] text-amber-400/80 font-semibold uppercase tracking-wider">Featured</span>
                        <div>
                          <p className="text-xs font-semibold text-zinc-300 leading-snug">Why {brandDna.name} Is the Smart Choice This Season</p>
                          <p className="text-[10px] text-zinc-500 mt-1">Sponsored by {brandDna.name}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* ── Native Content ── */}
                <div className="col-span-6 md:col-span-4 group relative rounded-xl overflow-hidden border border-white/[0.06] hover:border-eds-50/25 transition-colors cursor-pointer" style={{ background: "rgba(24, 24, 27, 0.9)" }}>
                  <div className="p-4">
                    <div className="flex items-center gap-2.5 mb-3">
                      ...
                      <p className="text-sm font-semibold text-zinc-200">Native Content</p>
                    </div>
                    <p className="text-[11px] text-zinc-500 mb-3">Editorial-style articles on vehicle pages that feel organic to the shopping experience.</p>
                    <div className="flex items-center gap-1.5">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
                      <span className="text-[10px] text-emerald-400/80 font-medium">Highest engagement rate</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-span-6 md:col-span-4 group relative rounded-xl overflow-hidden border border-white/[0.06] hover:border-eds-50/25 transition-colors cursor-pointer" style={{ background: "rgba(24, 24, 27, 0.9)" }}>
                  <div className="p-4">
                    <div className="flex items-center gap-2.5 mb-3">
                      ...
                      <p className="text-sm font-semibold text-zinc-200">Video Pre-Roll</p>
                    </div>
                    <p className="text-[11px] text-zinc-500 mb-3">15-30s video ads before editorial test drive and review content.</p>
                    <div className="flex items-center gap-1.5">
                      <div className="w-1.5 h-1.5 rounded-full bg-violet-400" />
                      <span className="text-[10px] text-violet-400/80 font-medium">95% viewability</span>
                    </div>
                  </div>
                </div>

                {/* ── Audience Targeting ── */}
                <div className="col-span-12 md:col-span-4 group relative rounded-xl overflow-hidden border border-white/[0.06] hover:border-eds-50/25 transition-colors cursor-pointer" style={{ background: "rgba(24, 24, 27, 0.9)" }}>
                  <div className="p-4">
                    <div className="flex items-center gap-2.5 mb-3">
                      ...
                      <p className="text-sm font-semibold text-zinc-200">Audience Targeting</p>
                    </div>
                    <p className="text-[11px] text-zinc-500 mb-3">Reach shoppers by make, model, price range, and purchase timeline.</p>
                    <div className="flex flex-wrap gap-1.5">
                      {["In-Market", "Make/Model", "Geo", "Retarget"].map((tag) => (
                        <span key={tag} className="text-[10px] text-cyan-300/80 bg-cyan-500/8 border border-cyan-500/15 px-2 py-0.5 rounded-full">{tag}</span>
                      ))}
                    </div>
                  </div>
                </div>
