      ...
      >
        ...
        <div className="border-b border-slate-700 px-8 flex gap-1 bg-slate-900/50">
          {(['format', 'targeting', 'budget'] as const).map((sec, idx) => (
            ...
            >
              <span className="text-xs font-bold mr-2" style={{ color: brandColors.primary }}>
                {idx + 1}
              </span>
              {sec === 'format' && 'Format'}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {FORMAT_OPTIONS.map((format) => (
                      <motion.button
                        ...
                        style={
                          selectedFormat === format.id
                            ? { boxShadow: `0 0 20px ${brandColors.primary}30` }
                            : {}
                        }
                      >
            ...
            {section === 'targeting' && (
              ...
              >
                        ...
                        style={
                          selectedMakes.includes(make)
                            ? {
                                ...
                                boxShadow: `0 0 12px ${brandColors.primary}50`,
                              }
                            : {}
                        }
                      >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          background: `linear-gradient(to right, ${brandColors.primary}, ${brandColors.primary}) 0% ${(radius / 100) * 100}%, #1e293b ${(radius / 100) * 100}% 100%`,
                        }}
                      />
                    </div>
                  </div>
                ...
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="p-6 rounded-lg border border-slate-700 bg-gradient-to-r from-slate-800/50 to-slate-700/50"
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-slate-800 rounded-lg appearance-none cursor-pointer"
                    style={{
                      background: `linear-gradient(to right, ${brandColors.primary}, ${brandColors.primary}) 0% ${((dailyBudget - 50) / (5000 - 50)) * 100}%, #1e293b ${((dailyBudget - 50) / (5000 - 50)) * 100}% 100%`,
                    }}
                  />
                ...
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="p-6 rounded-lg border-2 bg-gradient-to-br from-slate-800/50 to-slate-700/50"
                  style={{
                    borderColor: brandColors.primary + '50',
                    boxShadow: `0 0 20px ${brandColors.primary}20`,
                  }}
                >
        ...
        <div className="border-t border-slate-700 px-8 py-6 bg-gradient-to-r from-slate-900 to-slate-800 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="px-6 py-3 rounded-lg font-semibold text-white flex items-center gap-2 transition"
              style={{
                backgroundColor: brandColors.primary,
                boxShadow: `0 0 20px ${brandColors.primary}50`,
              }}
            >
              Place on Edmunds
              <ChevronRightIcon />
