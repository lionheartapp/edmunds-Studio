        ...
        {isLoading ? (
          ...
          >
            ...
            <div className="relative w-48 h-48 mb-10">
              ...
              {/* Layer 2a: Drop-in blob — visible during drop, fades out after landing */}
              <motion.div
                initial={{
                  y: -300,
                  scale: 1,
                ...
                transition={{
                  ...
                  opacity: { duration: 0.8, times: [0, 0.4, 0.55, 0.7, 0.85, 1] },
                }}
              ...
              {/* Layer 2b: Morphing blob — fades in after landing, morphs wildly (NOT clipped by parent) */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
